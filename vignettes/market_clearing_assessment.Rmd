...
names(sim_coef) <- names(coef(damdl_est))
...
model_obs <- c(nobs(eqmdl), nobs(bsmdl), nobs(damdl))
model_errors <- c(
  comp_means["fierr"],
  comp_means["bmerr"],
  comp_means["daerr"]
