...
bsmdl_mme <- sapply(variables,
  function(v) shortage_probability_marginal(bsmdl, bsmdl_est, v),
  USE.NAMES = FALSE
)
drmdl_mme <- sapply(variables,
  function(v) shortage_probability_marginal(drmdl, drmdl_est, v),
  USE.NAMES = FALSE
)
damdl_mme <- sapply(variables,
  function(v) shortage_probability_marginal(damdl, damdl_est, v),
  USE.NAMES = FALSE
)
samdl_mme <- sapply(variables,
  function(v) shortage_probability_marginal(samdl, samdl_est, v),
  USE.NAMES = FALSE
)
bsmdl_mem <- sapply(variables,
  function(v) {
    shortage_probability_marginal(bsmdl, bsmdl_est, v,
...
drmdl_mem <- sapply(variables,
  function(v) {
    shortage_probability_marginal(drmdl, drmdl_est, v,
      aggregate = "at_the_mean"
    )
  },
  USE.NAMES = FALSE
...
damdl_mem <- sapply(variables,
  function(v) {
    shortage_probability_marginal(damdl, damdl_est, v,
      aggregate = "at_the_mean"
    )
  },
  USE.NAMES = FALSE
...
samdl_mem <- sapply(variables,
  function(v) {
    shortage_probability_marginal(samdl, samdl_est, v,
      aggregate = "at_the_mean"
    )
  },
  USE.NAMES = FALSE
