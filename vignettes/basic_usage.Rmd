...
output:
  ...
  pdf_document:
    ...
    number_sections: yes
vignette: >
  %\VignetteIndexEntry{An example of estimations using the market models of the package}
...
aggregates <- c(
  demand = get_aggregate_demand(bsmdl, bsmdl_est),
  supply = get_aggregate_supply(bsmdl, bsmdl_est)
)
aggregates
```
