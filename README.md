...
in alignment with standard economic reasoning. By letting *γ* approach
...
assumptions of models (*D**A*) and (*D**M*), abstains from imposing any
...
asymptotically equivalent. The classes that implement these estimation
techniques are respectively
