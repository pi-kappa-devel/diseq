...
setMethod("initialize", "equation_stochastic_adjustment",
...
setMethod("set_parameters", signature(object = "equation_stochastic_adjustment"), function(object, parameters) {
