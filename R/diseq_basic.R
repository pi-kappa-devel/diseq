...
setMethod("gradient", signature(object = "diseq_basic"), function(object, parameters) {
  ...
  g[colnames(object@system@demand@independent_matrix)] <- colSums(partial_beta_d_of_loglh(object@system))
  g[colnames(object@system@supply@independent_matrix)] <- colSums(partial_beta_s_of_loglh(object@system))
  g[get_prefixed_variance_variable(object@system@demand)] <- sum(partial_var_d_of_loglh(object@system))
  g[get_prefixed_variance_variable(object@system@supply)] <- sum(partial_var_s_of_loglh(object@system))
...
setMethod("hessian", signature(object = "diseq_basic"), function(object, parameters) {
  ...
  h[get_prefixed_variance_variable(object@system@demand), colnames(pbeta_d_pvar_d)] <- t(pbeta_d_pvar_d)
  h[colnames(pbeta_d_pvar_d), get_prefixed_variance_variable(object@system@demand)] <- pbeta_d_pvar_d

  h[get_prefixed_variance_variable(object@system@supply), colnames(pbeta_d_pvar_s)] <- t(pbeta_d_pvar_s)
  h[colnames(pbeta_d_pvar_s), get_prefixed_variance_variable(object@system@supply)] <- pbeta_d_pvar_s
  ...
  h[get_prefixed_variance_variable(object@system@supply), colnames(pbeta_s_pvar_s)] <- t(pbeta_s_pvar_s)
  h[colnames(pbeta_s_pvar_s), get_prefixed_variance_variable(object@system@supply)] <- pbeta_s_pvar_s

  h[get_prefixed_variance_variable(object@system@demand), colnames(pbeta_s_pvar_d)] <- t(pbeta_s_pvar_d)
  h[colnames(pbeta_s_pvar_d), get_prefixed_variance_variable(object@system@demand)] <- pbeta_s_pvar_d
  ...
  if (object@system@correlated_shocks) {
    ...
    h[get_prefixed_variance_variable(object@system@demand), get_correlation_variable(object@system)] <- pvar_d_prho
    h[get_correlation_variable(object@system), get_prefixed_variance_variable(object@system@demand)] <- pvar_d_prho
    ...
    h[get_prefixed_variance_variable(object@system@supply), get_correlation_variable(object@system)] <- pvar_s_prho
    h[get_correlation_variable(object@system), get_prefixed_variance_variable(object@system@supply)] <- pvar_s_prho

    h[get_correlation_variable(object@system), get_correlation_variable(object@system)] <- prho_prho
  }
