...
setMethod("initialize", "eq_2sls", function(
  .Object,
  verbose = 0,
  key_columns,
...
setMethod("estimate", signature(object = "eq_2sls"), function(object, ...) {
  ...
  first_stage_formula <-
    paste0(object@system@demand@price_variable, " ~ ", paste0(first_stage_controls, collapse = " + "))
  ...
  demand_formula <- formula(paste0(object@system@quantity_variable, " ~ ", paste0(independent, collapse = " + ")))
