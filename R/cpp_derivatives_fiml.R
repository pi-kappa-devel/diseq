#' @include cpp_system_fiml.R


setGeneric("cpp_partial_alpha_d", function(object) {
  standardGeneric("cpp_partial_alpha_d")
})

setMethod("cpp_partial_alpha_d", signature(object = "cpp_system_fiml"), function(object) {
  # nolint start
...
setGeneric("cpp_partial_beta_d", function(object) {
  standardGeneric("cpp_partial_beta_d")
})

setMethod("cpp_partial_beta_d", signature(object = "cpp_system_fiml"), function(object) {
  # nolint start
...
setGeneric("cpp_partial_alpha_s", function(object) {
  standardGeneric("cpp_partial_alpha_s")
})

setMethod("cpp_partial_alpha_s", signature(object = "cpp_system_fiml"), function(object) {
  # nolint start
...
setGeneric("cpp_partial_beta_s", function(object) {
  standardGeneric("cpp_partial_beta_s")
})

setMethod("cpp_partial_beta_s", signature(object = "cpp_system_fiml"), function(object) {
  # nolint start
...
setGeneric("cpp_partial_var_d", function(object) {
  standardGeneric("cpp_partial_var_d")
})

setMethod("cpp_partial_var_d", signature(object = "cpp_system_fiml"), function(object) {
  # nolint start
...
setGeneric("cpp_partial_var_s", function(object) {
  standardGeneric("cpp_partial_var_s")
})

setMethod("cpp_partial_var_s", signature(object = "cpp_system_fiml"), function(object) {
  # nolint start
...
setGeneric("cpp_partial_rho", function(object) {
  standardGeneric("cpp_partial_rho")
})

setMethod("cpp_partial_rho", signature(object = "cpp_system_fiml"), function(object) {
  # nolint start
