...
#'   "cpp_eq_fiml", 500, 3, # model type, observed entities and time points
...
setMethod("minus_log_likelihood", signature(object = "cpp_eq_fiml"), function(object, parameters) {
...
setMethod(
  "estimate", signature(object = "cpp_eq_fiml"),
